...
def build_panels(qt):
    ...
    class SpyPanel(QtWidgets.QWidget):
        ...
        def __init__(self, parent=None):
            ...
            self._preview.setStyleSheet("background: {}; color: {}; border: 1px solid {}; border-radius: 4px; padding: 6px; font-family: Consolas;".format(COLORS["panel3"], COLORS["ok"], COLORS["border"]))
            ...
            details = QtWidgets.QLabel("Details:", self)
            details.setStyleSheet("color: {};".format(COLORS["dim"]))
